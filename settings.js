...
global.owner = process.env.OWNER_NUMBER  || '94759490765' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=mcExVBpb#nOyKUjGqaDt0aoc4BNU06PzWE7qF5w_-zuGyZF4qEnk' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94769490765,94759490765" : process.env.MODERATORS ,    
